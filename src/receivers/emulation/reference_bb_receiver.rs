...
pub struct ReferenceBBReceiver {
...
pub fn factory(
    ...
    let path = _config
        ...
        .unwrap_or("trace.reference_bb.csv")
        .to_string();
    Box::new(ReferenceBBReceiver::new(bus_rx, path))
}

crate::register_receiver!("reference_bb", factory);

impl AbstractReceiver for ReferenceBBReceiver {
